...
{
    public class Pets : Data
    {
        public Pets(Row row, DataTable datatable) : base(row, datatable)
        {
        ...
        public int LeashLength { get; set; }

        public string DefaultSkin { get; set; }

        public int HeroDeathAbilityLevel { get; set; }

        public string HeroDeathAbilityType { get; set; }

        public string HeroDeathAbilitySpell { get; set; }
    }
}
